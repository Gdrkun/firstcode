...
public class UserDaoImplement implements UserDao {
    public boolean login(String name, String password) {
        ...
        try {
            ...
            //注意查询语句中的单引号双引号
            ResultSet rs = DBconnect.selectSql("select * from vip where name='" + name + " 'and password='" + password + "';");
            while (rs.next()) {
    ...
    public boolean register(MyUser user) {
        ...
        int i = DBconnect.addUpdateDelete("insert into vip(name,password,id) " +
    ...
    public List<MyUser> getUserAll() {//返回用户信息集合
        ...
        try {
            ...
            ResultSet rs = DBconnect.selectSql("select * from vip");
            while (rs.next()) {
    ...
    public boolean update(String name, String id) {
        ...
        String sql = "update vip set name ='" + name
